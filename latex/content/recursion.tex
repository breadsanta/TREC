...
\noindent
\begin{center}
	\resizebox{0.49\textwidth}{!}{\includesvg{hanoi/hanoi-2_0}}
	\resizebox{0.49\textwidth}{!}{\includesvg{hanoi/hanoi-2_1}}
	\resizebox{0.49\textwidth}{!}{\includesvg{hanoi/hanoi-2_2}}
	\resizebox{0.49\textwidth}{!}{\includesvg{hanoi/hanoi-2_3}}
\end{center}
...
\noindent
\begin{center}
	\resizebox{0.32\textwidth}{!}{\includesvg{hanoi/hanoi-3_0}}
	\resizebox{0.32\textwidth}{!}{\includesvg{hanoi/hanoi-3_1}}
	\resizebox{0.32\textwidth}{!}{\includesvg{hanoi/hanoi-3_2}}
	\resizebox{0.32\textwidth}{!}{\includesvg{hanoi/hanoi-3_3}}
	\resizebox{0.32\textwidth}{!}{\includesvg{hanoi/hanoi-3_4}}
	\resizebox{0.32\textwidth}{!}{\includesvg{hanoi/hanoi-3_5}}
	\resizebox{0.32\textwidth}{!}{\includesvg{hanoi/hanoi-3_6}}
	\resizebox{0.32\textwidth}{!}{\includesvg{hanoi/hanoi-3_7}}
\end{center}
